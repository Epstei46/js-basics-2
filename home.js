...
let canWeDeliver = (zipCode) => {
    if (deliveryAreaZipCodes.includes(zipCode)){
        return `We can deliver to ${zipCode}`
    } else {
        return `Unfortunately, we cannot deliver to ${zipCode}`
    }
}
/*Below code is to test the code above.*/
...
// console.log(deals[1].desc) /*see original look for comparison*/
deals[1].desc = deals[1].desc.replace('March', 'April').trim()
// console.log(deals[1].desc) /*see edited look for comparison*/